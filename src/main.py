...
from models.merge_node import MergeNode
from models.start_node import StartNode
    ...
    while(True):
        ...
        if user_in == '1':
            if util.check_start_node_existence(activity_diagram.get_elements()):
                ...
                start_node = StartNode(name=start_node_name, element_type=util.START_NODE)
            ...
            if util.check_start_node_existence(activity_diagram.get_elements()):
                ...
                activity_node = ActivityNode(name=activity_node_name, element_type=util.ACTIVITY_NODE)
            ...
            if util.check_start_node_existence(activity_diagram.get_elements()):
                ...
                decision_node = DecisionNode(name=decision_node_name, element_type=util.DECISION_NODE)
            ...
            if util.check_start_node_existence(activity_diagram.get_elements()) and \
               util.check_join_possibility(activity_diagram.get_elements()):
                ...
                merge_node = MergeNode(name=merge_node_name, element_type=util.MERGE_NODE)
            ...
            if util.check_start_node_existence(activity_diagram.get_elements()):
                ...
                end_node = EndNode(name=end_node_name, element_type=util.END_NODE)
            ...
            print(f'Activity Diagram: {activity_diagram}')
            return
        else:
            clear()
            print('Invalid input. Please select again\n')
